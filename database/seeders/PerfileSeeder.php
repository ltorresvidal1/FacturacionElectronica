...
class PerfileSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $perfil1->idestado="1";
        $perfil1->created_at="2022-12-16 09:12";
        $perfil1->save();

        $perfil2 = new Perfiles();
        $perfil2->nombre="ADMINISTRADOR";
        $perfil2->sa_administrador="0";
        $perfil2->idestado="1";
        $perfil2->created_at="2022-12-16 09:12";
        $perfil2->save();

        $perfil3 = new Perfiles();
        $perfil3->nombre="FACTURADOR";
        $perfil3->sa_administrador="0";
        $perfil3->idestado="1";
        $perfil3->created_at="2022-12-16 09:12";
        $perfil3->save();
    }
}
